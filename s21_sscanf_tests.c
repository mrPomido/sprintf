/**
 *  @file: test_s21_sscanf.c
 *  @brief File for unit testing the s21_sscanf function.
 *
 *  Description:
 *  This file contains unit tests for the sscanf function implementation,
 * s21_sscanf. Each aspect of s21_sscanf is rigorously tested to ensure correct
 * functionality across various input formats and edge cases. Tests cover
 * parsing integers, floating-point numbers, strings, and combinations thereof.
 * Additionally, edge cases such as empty inputs, boundary conditions, and
 * malformed input formats are thoroughly examined.
 *
 *   The tests leverage the Check testing framework, providing detailed feedback
 * on test failures including line numbers, expected versus actual values, and
...
Suite *s21_sscanf_test(void) {
  ...
  tcase_add_test(tc, test_s21_sscanf_test_0);
  tcase_add_test(tc, test_s21_sscanf_test_d_1);
  tcase_add_test(tc, test_s21_sscanf_test_d_2);
  tcase_add_test(tc, test_s21_sscanf_test_d_3);
  tcase_add_test(tc, test_s21_sscanf_test_d_4);
  tcase_add_test(tc, test_s21_sscanf_test_d_5);
  tcase_add_test(tc, test_s21_sscanf_test_d_6);
  tcase_add_test(tc, test_s21_sscanf_test_d_7);
  tcase_add_test(tc, test_s21_sscanf_test_d_8);
  tcase_add_test(tc, test_s21_sscanf_test_d_9);
  tcase_add_test(tc, test_s21_sscanf_test_hd_1);
  tcase_add_test(tc, test_s21_sscanf_test_hd_2);
  tcase_add_test(tc, test_s21_sscanf_test_hd_3);
  tcase_add_test(tc, test_s21_sscanf_test_hd_4);
  tcase_add_test(tc, test_s21_sscanf_test_hd_5);
  tcase_add_test(tc, test_s21_sscanf_test_hd_6);
  tcase_add_test(tc, test_s21_sscanf_test_hd_7);
  tcase_add_test(tc, test_s21_sscanf_test_hd_8);
  tcase_add_test(tc, test_s21_sscanf_test_hd_9);
  tcase_add_test(tc, test_s21_sscanf_test_ld_1);
  tcase_add_test(tc, test_s21_sscanf_test_ld_2);
  tcase_add_test(tc, test_s21_sscanf_test_ld_3);
  tcase_add_test(tc, test_s21_sscanf_test_ld_4);
  tcase_add_test(tc, test_s21_sscanf_test_ld_5);
  tcase_add_test(tc, test_s21_sscanf_test_ld_6);
  tcase_add_test(tc, test_s21_sscanf_test_ld_7);
  tcase_add_test(tc, test_s21_sscanf_test_ld_8);
  tcase_add_test(tc, test_s21_sscanf_test_ld_9);
  tcase_add_test(tc, test_s21_sscanf_test_lld_1);
  tcase_add_test(tc, test_s21_sscanf_test_lld_2);
  tcase_add_test(tc, test_s21_sscanf_test_lld_3);
  tcase_add_test(tc, test_s21_sscanf_test_lld_4);
  tcase_add_test(tc, test_s21_sscanf_test_lld_5);
  tcase_add_test(tc, test_s21_sscanf_test_lld_6);
  tcase_add_test(tc, test_s21_sscanf_test_lld_7);
  tcase_add_test(tc, test_s21_sscanf_test_lld_8);
  tcase_add_test(tc, test_s21_sscanf_test_lld_9);
  tcase_add_test(tc, test_s21_sscanf_test_u_1);
  tcase_add_test(tc, test_s21_sscanf_test_u_2);
  tcase_add_test(tc, test_s21_sscanf_test_u_3);
  tcase_add_test(tc, test_s21_sscanf_test_u_4);
  tcase_add_test(tc, test_s21_sscanf_test_u_5);
  tcase_add_test(tc, test_s21_sscanf_test_u_6);
  tcase_add_test(tc, test_s21_sscanf_test_u_7);
  tcase_add_test(tc, test_s21_sscanf_test_u_8);
  tcase_add_test(tc, test_s21_sscanf_test_u_9);
  tcase_add_test(tc, test_s21_sscanf_test_hu_1);
  tcase_add_test(tc, test_s21_sscanf_test_hu_2);
  tcase_add_test(tc, test_s21_sscanf_test_hu_3);
  tcase_add_test(tc, test_s21_sscanf_test_hu_4);
  tcase_add_test(tc, test_s21_sscanf_test_hu_5);
  tcase_add_test(tc, test_s21_sscanf_test_hu_6);
  tcase_add_test(tc, test_s21_sscanf_test_hu_7);
  tcase_add_test(tc, test_s21_sscanf_test_hu_8);
  tcase_add_test(tc, test_s21_sscanf_test_hu_9);
  tcase_add_test(tc, test_s21_sscanf_test_lu_1);
  tcase_add_test(tc, test_s21_sscanf_test_lu_2);
  tcase_add_test(tc, test_s21_sscanf_test_lu_3);
  tcase_add_test(tc, test_s21_sscanf_test_lu_4);
  tcase_add_test(tc, test_s21_sscanf_test_lu_5);
  tcase_add_test(tc, test_s21_sscanf_test_lu_6);
  tcase_add_test(tc, test_s21_sscanf_test_lu_7);
  tcase_add_test(tc, test_s21_sscanf_test_lu_8);
  tcase_add_test(tc, test_s21_sscanf_test_lu_9);
  tcase_add_test(tc, test_s21_sscanf_test_llu_1);
  tcase_add_test(tc, test_s21_sscanf_test_llu_2);
  tcase_add_test(tc, test_s21_sscanf_test_llu_3);
  tcase_add_test(tc, test_s21_sscanf_test_llu_4);
  tcase_add_test(tc, test_s21_sscanf_test_llu_5);
  tcase_add_test(tc, test_s21_sscanf_test_llu_6);
  tcase_add_test(tc, test_s21_sscanf_test_llu_7);
  tcase_add_test(tc, test_s21_sscanf_test_llu_8);
  tcase_add_test(tc, test_s21_sscanf_test_llu_9);
  tcase_add_test(tc, test_s21_sscanf_test_i_1);
  tcase_add_test(tc, test_s21_sscanf_test_i_2);
  tcase_add_test(tc, test_s21_sscanf_test_i_3);
  tcase_add_test(tc, test_s21_sscanf_test_i_4);
  tcase_add_test(tc, test_s21_sscanf_test_i_5);
  tcase_add_test(tc, test_s21_sscanf_test_i_6);
  tcase_add_test(tc, test_s21_sscanf_test_i_7);
  tcase_add_test(tc, test_s21_sscanf_test_i_8);
  tcase_add_test(tc, test_s21_sscanf_test_i_9);
  tcase_add_test(tc, test_s21_sscanf_test_f_1);
  tcase_add_test(tc, test_s21_sscanf_test_f_2);
  tcase_add_test(tc, test_s21_sscanf_test_f_3);
  tcase_add_test(tc, test_s21_sscanf_test_f_4);
  tcase_add_test(tc, test_s21_sscanf_test_f_5);
  tcase_add_test(tc, test_s21_sscanf_test_f_6);
  tcase_add_test(tc, test_s21_sscanf_test_lf_1);
  tcase_add_test(tc, test_s21_sscanf_test_lf_2);
  tcase_add_test(tc, test_s21_sscanf_test_lf_3);
  tcase_add_test(tc, test_s21_sscanf_test_lf_4);
  tcase_add_test(tc, test_s21_sscanf_test_lf_5);
  tcase_add_test(tc, test_s21_sscanf_test_lf_6);
  tcase_add_test(tc, test_s21_sscanf_test_llf_1);
  tcase_add_test(tc, test_s21_sscanf_test_llf_2);
  tcase_add_test(tc, test_s21_sscanf_test_llf_3);
  tcase_add_test(tc, test_s21_sscanf_test_llf_4);
  tcase_add_test(tc, test_s21_sscanf_test_llf_5);
  tcase_add_test(tc, test_s21_sscanf_test_llf_6);
  tcase_add_test(tc, test_s21_sscanf_test_eEgG_1);
  tcase_add_test(tc, test_s21_sscanf_test_eEgG_2);
  tcase_add_test(tc, test_s21_sscanf_test_o_1);
  tcase_add_test(tc, test_s21_sscanf_test_o_2);
  tcase_add_test(tc, test_s21_sscanf_test_o_3);
  tcase_add_test(tc, test_s21_sscanf_test_o_4);
  tcase_add_test(tc, test_s21_sscanf_test_o_5);
  tcase_add_test(tc, test_s21_sscanf_test_xX_1);
  tcase_add_test(tc, test_s21_sscanf_test_xX_2);
  tcase_add_test(tc, test_s21_sscanf_test_xX_3);
  tcase_add_test(tc, test_s21_sscanf_test_xX_4);
  tcase_add_test(tc, test_s21_sscanf_test_xX_5);
  tcase_add_test(tc, test_s21_sscanf_test_pn_1);
  tcase_add_test(tc, test_s21_sscanf_test_c_1);
  tcase_add_test(tc, test_s21_sscanf_test_c_2);
  tcase_add_test(tc, test_s21_sscanf_test_c_3);
  tcase_add_test(tc, test_s21_sscanf_test_s_1);
  tcase_add_test(tc, test_s21_sscanf_test_s_2);
  tcase_add_test(tc, test_s21_sscanf_test_s_3);
  tcase_add_test(tc, test_s21_sscanf_test_s_4);
  tcase_add_test(tc, test_s21_sscanf_test_s_5);
  tcase_add_test(tc, test_s21_sscanf_test_combo_1);
  tcase_add_test(tc, test_s21_sscanf_test_combo_2);
  ...
  tcase_add_test(tc, upper_hex_256);
  ...
  tcase_add_test(tc, lower_hex_256);
